...
public class ChatMessage {
    ...
    @Deprecated(forRemoval = true)
    public ChatMessage(@Nullable Player sender, String senderName, String contentPlaintext, TextComponent prepend, TextComponent text) {
        this(sender, senderName, new ChatMessageParser.MessageBundle(prepend, text, null));
    }

    @Deprecated(forRemoval = true)
    public ChatMessage(
            @Nullable Player sender, String senderName, String contentPlaintext, @Nullable TextComponent prepend, TextComponent text,
            @Nullable TextComponent append
    ) {
    ...
    public static class RawToKyoriConverter implements Converter<JsonNode, TextComponent> {
        ...
        public TextComponent convert(JsonNode json) {
            return json == null || json.isNull() ? Component.text("") : (TextComponent) provider.instance().deserialize(json.toString());
        }
