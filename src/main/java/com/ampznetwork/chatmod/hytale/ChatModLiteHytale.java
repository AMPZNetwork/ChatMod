...
import com.ampznetwork.chatmod.config.HytaleConfigFile;
import com.ampznetwork.chatmod.hytale.command.ChannelCommand;
import com.ampznetwork.chatmod.hytale.command.ShoutCommand;
...
public class ChatModLiteHytale extends JavaPlugin implements ChatDispatcher, PlayerAdapter, PacketCaster {
    ...
    public void sendToPlayer(ComponentLike component, @NotNull Player player) {
        ...
        getPlayerRef(player.getUuid()).ifPresent(ref -> ref.sendMessage(message));
    }
    ...
    public @Nullable Player getPlayer(UUID playerId) {
        return Optional.ofNullable(playerId)
                ...
                .map(ref -> new Player(playerId, ref != null ? ref.getUsername() : "Hytale User"))
                .orElse(null);
    }
